...
craving <- read.table("~/PSYC489K-SU24/Datasets/craving.csv", sep = ",", header =TRUE)
```
...
H0: B1 \<= 0 (i.e., the effect of depression on alcohol cravings will be negative or zero).
